...
def main():
    ...
    parser.add_argument("--dataset", default='./data-with-our-exp/train-prompts.json', type=str)
    parser.add_argument("--output", default='./data-with-our-exp/train-exp.json', type=str)
    # parser.add_argument("--dataset", default='./data-with-our-exp/dev-prompts.json', type=str)
    # parser.add_argument("--output", default='./data-with-our-exp/dev-exp.json', type=str)
    # parser.add_argument("--dataset", default='./data-with-our-exp/test-prompts.json', type=str)
    # parser.add_argument("--output", default='./data-with-our-exp/test-exp.json', type=str)
    ###############################
